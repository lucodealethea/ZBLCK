class ZCL_ZBLCK_FIAP_MPC definition
  public
...
TT_POSTHDR type standard table of TS_POSTHDR .
  ...
  constants GC_POSTHDR type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PostHdr' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZBLCK_FIAP_MPC============CP' ##NO_TEXT.
...
CLASS ZCL_ZBLCK_FIAP_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZBLCK_FIAP_SRV' ).

define_posthdr( ).
  endmethod.


  method DEFINE_POSTHDR.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PostHdr' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PostHdrSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190523123940'.                  "#EC NOTEXT
