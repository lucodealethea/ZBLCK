class ZCL_ZZ_CUSTOMER_FB01_MPC definition
  public
...
public section.
  ...
  end of TS_CUSTOMERINVOICE .
  types:
TT_CUSTOMERINVOICE type standard table of TS_CUSTOMERINVOICE .
  types:
  ...
  constants GC_CUSTOMERINVOICE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'CustomerInvoice' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZZ_CUSTOMER_FB01_MPC======CP' ##NO_TEXT.

  methods DEFINE_CUSTOMERINVOICE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZZ_CUSTOMER_FB01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZZ_CUSTOMER_FB01_SRV' ).

define_customerinvoice( ).
  endmethod.


  method DEFINE_CUSTOMERINVOICE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'CustomerInvoice' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZZ_CUSTOMER_FB01_MPC=>TS_CUSTOMERINVOICE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'CustomerInvoiceSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190517152621'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'CustomerInvoice'.                            "#EC NOTEXT
