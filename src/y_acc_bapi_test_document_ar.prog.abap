*&---------------------------------------------------------------------*
*& Report  Y_ACC_BAPI_TEST_DOCUMENT_AR                                 *
*&                                                                     *
*&---------------------------------------------------------------------*
*& Wrapper to test FI-AR Posting in Minimal BE Conditions              *
*&                                                                     *
*&---------------------------------------------------------------------*

REPORT  z_acc_bapi_test_document_ar                  .
...
FORM fill_accountgl.
  ...
  it_accountgl-gl_account     = '7000300000'.
...
* IT_ACCOUNTGL-CSHDIS_IND     =
  IT_ACCOUNTGL-ALLOC_NMBR     = 'TS0000011'. "VARIABLE"
...
* IT_ACCOUNTGL-PART_PRCTR     =
  it_accountgl-wbs_element    = '/000/BCH-000/CUST2'. "VARIABLE"
...
* OBJ_TYPE has to be replaced by customers object key (Y* or Z*)
  ...
  gd_documentheader-header_txt = 'BAPI Test AR'.               "#EC NOTEXT
* gd_documentheader-obj_key_r  =
* GD_DOCUMENTHEADER-reason_rev =
  gd_documentheader-comp_code  = 'BE99'.
...
* GD_DOCUMENTHEADER-FIS_PERIOD =
  ...
  gd_documentheader-ref_doc_no = 'TS000000011PZIN'. "VARIABLE"
...
FORM fill_accountar.
  ...
  it_accountreceivable-customer   = '0002000022'.
...
* IT_ACCOUNTRECEIVABLE-VAT_REG_NO =
  it_accountreceivable-alloc_nmbr = 'TS000ALLOCNR'. "VARIABLE"
  it_accountreceivable-item_text  = 'AR Item Text'. "VARIABLE"
...
FORM fill_accounttax.
  ...
  it_accounttax-gl_account = '4510000000'.
